...
add_action('init', 'cmb2_conditionals_load_actions');
...
function cmb2_conditionals_footer()
{
	...
	//wp_enqueue_script('cmb2-conditionals', get_template_directory_uri('/cmb2-conditionals.js', __FILE__ ), array('jquery'), '1.0.2', true);
	wp_enqueue_script( 'cmb2-conditionals', get_template_directory_uri() . '/inc/cmb2/cmb2-conditionals.js', array('jquery'), '1.0.2', true);
}
