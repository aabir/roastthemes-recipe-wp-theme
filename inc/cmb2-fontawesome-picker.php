...
class KS_FontAwesome_IconPicker {
  ...
  public function sanitize( $sanitized_val, $val ) {
    ...
    wp_enqueue_script( 'cmb2-fontawesome-picker', get_template_directory_uri(). '/js/fontawesome-iconpicker.min.js', array('jquery'), self::VERSION, true );
		wp_enqueue_script( 'cmb2-fontawesome-picker-init', get_template_directory_uri(). '/js/fontawesome-picker-init.js', array('cmb2-fontawesome-picker'), self::VERSION, true );
		wp_enqueue_style('cmb2-fontawesome-css', get_stylesheet_directory_uri().'/css/cmb2-font-awesome.min.css', false, '1.0', 'all');
		wp_enqueue_style('fontawesome-iconpicker', get_stylesheet_directory_uri().'/css/fontawesome-iconpicker.min.css', false, '1.0', 'all');
	}
}
